...
// node_modules/react-ga4/dist/index.mjs
var gtag = (...args) => {
...
var GA4 = class {
  constructor() {
    ...
    __publicField(this, "_currentMeasurementId");
    __publicField(this, "_hasLoadedGA");
    __publicField(this, "_isQueuing");
    __publicField(this, "_queueGtag");
    ...
    __publicField(this, "_loadGA", (GA_MEASUREMENT_ID, nonce, gtagUrl = "https://www.googletagmanager.com/gtag/js") => {
    ...
    __publicField(this, "_toGtagOptions", (gaOptions) => {
      if (!gaOptions)
        return;
      const mapFields = {
    ...
    */
    __publicField(this, "initialize", (GA_MEASUREMENT_ID, options = {}) => {
    ...
    __publicField(this, "set", (fieldsObject) => {
      if (!fieldsObject) {
    ...
    __publicField(this, "_gaCommandSendEvent", (eventCategory, eventAction, eventLabel, eventValue, fieldsObject) => {
    ...
    __publicField(this, "_gaCommandSendEventParameters", (...args) => {
    ...
    __publicField(this, "_gaCommandSendTiming", (timingCategory, timingVar, timingValue, timingLabel) => {
    ...
    __publicField(this, "_gaCommandSendPageview", (page, fieldsObject) => {
    ...
    __publicField(this, "_gaCommandSendPageviewParameters", (...args) => {
      if (typeof args[0] === "string")
    ...
    __publicField(this, "_gaCommandSend", (...args) => {
    ...
    __publicField(this, "_gaCommandSet", (...args) => {
      if (typeof args[0] === "string")
        args[0] = { [args[0]]: args[1] };
      this._gtag("set", this._toGtagOptions(args[0]));
    });
    __publicField(this, "_gaCommand", (command, ...args) => {
      switch (command) {
        case "send":
    ...
    * @param {Object} [params]
    */
    __publicField(this, "event", (optionsOrName, params) => {
    ...
    __publicField(this, "send", (fieldObject) => {
      this._gaCommand("send", fieldObject);
    });
    this.reset();
  }
